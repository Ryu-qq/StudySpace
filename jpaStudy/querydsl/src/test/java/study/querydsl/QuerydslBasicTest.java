...
public class QuerydslBasicTest {
    ...
    public void before(){
        ...
        Team teamA = new Team("tesmA");
        Team teamB = new Team("tesmB");
        em.persist(teamA);
        em.persist(teamB);
    ...
    public void findDtoByJPQL(){
        List<MemberDto> resultList = em.createQuery("select new study.querydsl.dto.MemberDto(m.age, m.username) "
...
//                        Expressions.stringTemplate("fuction('lower', {0})", member.username)
//                ))
